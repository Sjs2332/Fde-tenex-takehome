        ...
        <footer className="w-full border-t bg-muted/30 py-12">
            <div className="flex flex-col items-center justify-center gap-4 w-full px-4">
                ...
                <div className="flex items-center justify-center gap-6">
                    ...
                    <Link href="https://github.com/Sjs2332/Fde-tenex-takehome" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
